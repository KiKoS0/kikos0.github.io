...
export function __wbg_get_renderingscene_height(a: number): number;
export function __wbg_set_renderingscene_height(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h40e419e8c3043e6d(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h41c914a024c941fc(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h617d0b276d6cc26c(a: number, b: number, c: number, d: number): void;
